...
def input_fn(csv_data_file,mode):
    features, label = TF_Data(csv_data_file).input_fn(mode=mode)
...
if __name__ == '__main__':
    ...
    #     print(len(dataset[0]))
    #     print(len(dataset[1]))
    # dataset = tf.data.TextLineDataset('/data1/tmpdata/zhangqifan/data/rawdata/test/part_0.csv')
    data = TF_Data('/home/leadtek/zhangqifan/train/test.csv')
    data1 = data.input_fn()
    with tf.Session() as sess:
