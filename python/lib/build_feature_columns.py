...
def build_model_columns():
    ...
    _cross_feat_conf_list = Config().read_cross_feature_conf()
    ...
    for cross_features, hash_bucket_size, is_deep in _cross_feat_conf_list:
        cf_list = []
        for f in cross_features:

            f_type = _feature_conf_dic[f]["type"]
            f_tran = _feature_conf_dic[f]["transform"]
            f_param = _feature_conf_dic[f]["parameter"]
            if f_tran == 'identity':
